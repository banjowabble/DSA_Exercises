...
public class Point implements Comparable<Point> {
    ...
    public double slopeTo(Point that) {
        ...
        if (that.x - this.x == 0 && that.y - this.y == 0) { // Degenerate line segment
            return Double.NEGATIVE_INFINITY;
        } else if (that.x - this.x == 0) { // Vertical line segment
    ...
    /**
     * Comparator to compare 2 points by the slope they make with this point
     */
    private class SlopeComparator implements Comparator<Point> {
        ...
        public int compare(Point t, Point t1) {
            return Double.compare(thisPoint.slopeTo(t), thisPoint.slopeTo(t1));
        }
    }
